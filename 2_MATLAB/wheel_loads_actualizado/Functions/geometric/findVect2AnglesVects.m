function [t1,t2] = findVect2AnglesVects(vect1,angle1,vect2,angle2)
%% Find a vector that forms an angle of 'angle1' deg with 'vect1', and an angle of 'angle2' deg with 'vect2'
...
kab = cos(angle1*pi/180);
kac = cos(angle2*pi/180); 

Xab = vect1(1)/norm(vect1);
Xac = vect2(1)/norm(vect2);
Yab = vect1(2)/norm(vect1);
Yac = vect2(2)/norm(vect2);
Zab = vect1(3)/norm(vect1);
Zac = vect2(3)/norm(vect2);
