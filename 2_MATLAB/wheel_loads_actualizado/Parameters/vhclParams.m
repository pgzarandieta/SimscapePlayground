...
COG = (Sprung_mass_COG*Sprung_mass + Driver_COG*Driver_mass + Unsprung_mass_COG_front*Unsprung_mass_front*2.*[1 0 1] + Unsprung_mass_COG_rear*Unsprung_mass_rear*2.*[1 0 1])/Mass + [0 0 100];
% Todas las coordenadas tienen la referencia del CAD, en el cual el suelo no tiene por que tener z=0. En el caso del upm04e, la z del suelo es -100, por eso se suman 100 a esta coordenada para calcular la altura real del COG
...
FS_camber = 0; %deg of static camber at reference ride height
RS_camber = 0;
