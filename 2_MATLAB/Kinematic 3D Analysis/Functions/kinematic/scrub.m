function [scrub] = scrub(X, tireRadius, Xaxis, Yaxis, Zaxis)
%%Calculate scrub radius for suspension defined by X and tireRadius. 
...
for i = 1:L(1)
    for j = 1:L(2)
        for k = 1:L(3)
            ...
            scrub(i,j,k) = norm(projectVectPlane(intersectPlaneLine([0 0 1], contactPatch, X(13:15,i,j,k)-X(16:18,i,j,k),X(16:18,i,j,k))-contactPatch, cross([0 0 1],X(28:30,i,j,k))));
        end
    end
end
end
