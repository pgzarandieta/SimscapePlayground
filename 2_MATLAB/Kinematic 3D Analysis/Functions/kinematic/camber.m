function [camber] = camber(X, Xaxis, Yaxis, Zaxis)
%%Calculate camber angle for suspension defined by X and tireRadius
...
for i = 1:L(1)
    for j = 1:L(2)
        for k = 1:L(3)
            camber(i,j,k) = abs(vectsAngle([0; X(29:30,i,j,k)],[0 0 1],'deg'))-90;
        end
    end
end
end
